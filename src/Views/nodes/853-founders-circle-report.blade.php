...
@foreach ([ 144 => 'Indoor', 145 => 'Greenhouse/Mixed', 143 => 'Outdoor' ] as $typeID => $typeName)
    <div class="slCard nodeWrap">
        <h2 class="slBlueDark">
            ...
            @else 1c. 
            @endif 
            {{ $typeName }} Scores by Area of Flowering Canopy
        </h2>
...
<?php /* {!! $scoreSets["statScorVert"]->printTblFltRowsCalc('vert', 'farm', 'prodens', 'avg') !!} */ ?>
...
@foreach ([ 144 => 'Indoor', 145 => 'Greenhouse/Mixed', 143 => 'Outdoor' ] 
    ...
    <?php $statEnv->addCurrFilt('farm', $typeID); ?>
        {!! $statEnv->tblPercHasDatEnvs($typeID) !!}
