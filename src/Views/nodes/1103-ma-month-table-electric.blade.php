<!-- generated from resources/views/vendor/cannabisscore/nodes/1103-ma-month-table-electric.blade.php -->
...
<div id="nLabel{{ $nID }}" class="nPrompt">
    <h4 class="slBlueDark">Electricity consumption</h4>
</div>
<div class="nFld">
    <table class="table slSpreadTbl"><tbody>
        ...
        <tr>
            ...
            <th class="cl1"><b>
                kWh <span class="txtDanger" title="required">*required</span>
            </b></th>
            <th class="cl1"><b>
                kW <span class="txtDanger" title="required">*required</span>
            </b></th>
        </tr>
