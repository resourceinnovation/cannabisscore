...
@if (isset($GLOBALS["SL"]->x["srchRes"]["name"]) 
    && intVal($GLOBALS["SL"]->x["srchRes"]["name"]) > 0)
...
@if (isset($GLOBALS["SL"]->x["srchRes"]["dump"]) 
    && intVal($GLOBALS["SL"]->x["srchRes"]["dump"]) > 0)
    {!! view('vendor.cannabisscore.inc-tbl-powerscore-submissions', [
