<!-- generated from resources/views/vendor/cannabisscore/nodes/1122-ma-month-table-water.blade.php -->
...
<div id="nLabel{{ $nID }}" class="nPrompt">
    <h4 class="slBlueDark">Water consumption</h4>
</div>
<div class="nFld">
    <table class="table slSpreadTbl"><tbody>
        ...
        <tr>
            ...
            <th class="cl1"><b>
                Gallons <span class="txtDanger" title="required">*required</span>
            </b></th>
        </tr>
