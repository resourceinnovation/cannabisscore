...
@foreach ([ 144 => 'Indoor', 145 => 'Greenhouse/Mixed', 143 => 'Outdoor' ] as $typeID => $typeName)
    <div class="slCard greenline nodeWrap">
    <h2 class="slBlueDark">@if ($typeID == 144) 1a. @elseif ($typeID == 145) 1b. @else 1c. @endif {{ $typeName }} Scores by Type of Flowering HVAC</h2>
    {!! $scoreSets["statScorHvcF" . $typeID]->printScoreAvgsTbl('hvac', 
...
@foreach ([ 144 => 'Indoor', 145 => 'Greenhouse/Mixed', 143 => 'Outdoor' ] as $typeID => $typeName)
    <div class="slCard greenline nodeWrap">
    <h2 class="slBlueDark">@if ($typeID == 144) 2a. @elseif ($typeID == 145) 2b. @else 2c. @endif {{ $typeName }} Scores by Type of Vegetative HVAC</h2>
    {!! $scoreSets["statScorHvcV" . $typeID]->printScoreAvgsTbl('hvac', 
...
@foreach ([ 144 => 'Indoor', 145 => 'Greenhouse/Mixed', 143 => 'Outdoor' ] as $typeID => $typeName)
    <div class="slCard greenline nodeWrap">
    <h2 class="slBlueDark">@if ($typeID == 144) 3a. @elseif ($typeID == 145) 3b. @else 3c. @endif {{ $typeName }} Scores by Type of Cloning/Mother HVAC</h2>
    {!! $scoreSets["statScorHvcC" . $typeID]->printScoreAvgsTbl('hvac', 
...
@foreach ($sfFarms[0] as $i => $farmDef)
    @if ($sfFarms[1][$i] != 'Outdoor')
        ...
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-247" target="_blank">System A</a>
        <!--- <sub class="slGrey">5</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-248" target="_blank">System B</a>
        <!--- <sub class="slGrey">1</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-249" target="_blank">System C</a>
        <!--- <sub class="slGrey">0</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-250" target="_blank">System D</a>
        <!--- <sub class="slGrey">0</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-356" target="_blank">System E</a>
        <!--- <sub class="slGrey">0</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-357" target="_blank">System F</a>
        <!--- <sub class="slGrey">0</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-251" target="_blank">Other System</a>
        <!--- <sub class="slGrey">0</sub> --->
         </th>              <th>
        <a href="/dash/compare-powerscores?fltFarm={{ $farmDef }}&amp;fltHvac=160-360" target="_blank">None</a>
