...
<textarea class="form-control form-control-lg" name="logCommFld" id="logCommFldID" 
    style="height: 83px;"></textarea>
<input type="submit" class="btn btn-secondary mT5" value="Add New Communication">
</form>
<style> body { background: #EEF5E6; } </style>
@endsection