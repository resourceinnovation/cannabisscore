...
<p class="slGrey">
This little tool selects a random PowerScore which have completed the survey, and have data for their total utility bill
(either entered or uploaded).
</p>

@if ($GLOBALS["SL"]->REQ->has('getRandom') && intVal($GLOBALS["SL"]->REQ->get('getRandom')) == 2)
    <div id="randScore" class="w100"></div>
    <script type="text/javascript"> $(document).ready(function(){
        setTimeout(function() { $("#randScore").load("/calculated/u-{{ $randScore->PsID }}?ajax=1"); }, 10);
    }); </script>
@else
